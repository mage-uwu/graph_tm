/* fastgen: fastlae with one model's blocks compiled to straight-line C (T <= 64; longer inputs fall
 * back to the interpreter). Same commands and outputs as fastlae; verify still checks every score.
