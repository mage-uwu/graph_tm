 ...
 *              channels in the serial order). 4-core Xeon, 16x1024, seq 64: supervised batch 32 1.03 -> 0.69
 *              s/step; pretraining batch 64 4.19 -> 3.41 s/step (the 30k-word output layer is now ~2/3 of it).
