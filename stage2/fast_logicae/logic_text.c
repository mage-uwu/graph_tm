/* fast_logicae: GENERATED by make_source.py (logic-bert + transfer, global, hard, fasttrain patches +
...
static Options parse_options(int argc,char **argv) {
    Options o={0};o.c=defaults();o.threads=thread_count();o.every=100;o.repeats=40;o.warmup=5;o.seed=17;o.format="ids";
